...
composable multi-document patches (requires **Talos >= 1.14**). Nothing in this directory is applied automatically; configs are
...
- **Secrets never live in this repo.** All sensitive values are `op://Homelab/talos/...`
